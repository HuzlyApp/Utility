...
// Lightweight inline SVG icons (stroke-based, currentColor). Avoids adding an
// icon-library dependency. Each accepts standard SVG props + className.
...
export const SparklesIcon = (p: IconProps) => (
  <svg {...base(p)}>
    ...
    <path d="M18.5 5.5 16 8M8 16l-2.5 2.5M18.5 18.5 16 16M8 8 5.5 5.5" />
  </svg>
);
